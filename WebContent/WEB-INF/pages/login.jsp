...
body {
	background-image: url('${ctx}/images/backimg.jpeg');
}
...
<body>
	...
	<div class="login-box">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" name="account" id="account" class="layui-input"
						lay-verify="required" placeholder="请输入登陆账号" autofocus="autofocus"
						value="">
				</div>
			</div>
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="password" name="password" id="password"
						class="layui-input" lay-verify="required" placeholder="******"
						value="">
				</div>
			</div>
		...
		<div class="copyright">
			© 2020-2021 <a href="#" target="_blank">TanJiaJun</a> All Rights
			Reserved.
		</div>
	</div>
...
function gologin(){
	...
	if(account == ""){
		...
		$.ajax({
			url:'${ctx}/auditor/dologin',
			type:'post',
			dataType:'json',
			data:{'user_id':account,'password':password},
			success:function(data){
				if(data.code == 0){ //登陆成功
					layer.msg(data.msg,{time:1000}); 
					setTimeout(function(){
						window.location.href = '${ctx}/auditor/goManager';
					},1000);
				}else if(data.code == 1){
					layer.msg(data.msg);	
				}else{
