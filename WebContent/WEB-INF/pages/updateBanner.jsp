	...
	<div style="margin: 15px;">
		<div class="layui-form">
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" name="title" value="${banner.title}"
						autocomplete="off" class="layui-input" lay-verify="title"
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" name="orderStatus" value="${banner.orderStatus}"
						autocomplete="off" class="layui-input" lay-verify="orderStatus"
						placeholder="请输入排序" style="width: 390px">
				</div>
			</div>
