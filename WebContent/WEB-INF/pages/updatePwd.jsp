	...
	<div style="padding-left: 50px;; padding-top: 30px;">
		<div class="layui-form">
			...
			<div class="layui-form-item">
				<div class="layui-inline">
					<label class="layui-form-label"><span
						style="color: red; font-size: 16px !important;; margin-right: 5px;">*</span>新密码</label>
					<div class="layui-input-inline">
						<input type="password" id="newpassword"
							class="layui-input newsAuthor" lay-verify="required"
							placeholder="请输入新密码">
			...
			<div class="layui-form-item">
				<div class="layui-inline">
					<label class="layui-form-label"><span
						style="color: red; font-size: 16px !important;; margin-right: 5px;">*</span>确认密码</label>
					<div class="layui-input-inline">
...
layui.use('layer',function(){
    ...
    $("#send").on('click',function(){
      ...
      if(!password){
    	  ...
    	  $.ajax({
     		 url:'${ctx}/auditor/updatePassword',
     		 type:'post',
     		 dataType:'json',
