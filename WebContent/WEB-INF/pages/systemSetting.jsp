		...
		<div class="layui-form">
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" name="systemName" value="${system.systemName}"
						autocomplete="off" class="layui-input" lay-verify="systemName"
						placeholder="请输入平台名称" style="width: 390px">
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">地址：</label>
				<div class="layui-input-block">
					<input type="text" name="addres" value="${system.addres}"
						autocomplete="off" class="layui-input" lay-verify="addres"
						placeholder="请输入地址" style="width: 390px">
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">作者姓名：</label>
				<div class="layui-input-block">
					<input type="text" name="author" value="${system.author}"
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" name="phone" value="${system.phone}"
						autocomplete="off" class="layui-input" lay-verify="phone"
						placeholder="请输入标题" style="width: 390px">
				</div>
			</div>
...
layui.use([ 'form', 'layer'],
		...
		form.on('submit(demo1)', function(data) {
			$.ajax({
				type : "post",
				url : "${ctx}/system/updateSysInfo",
				dataType:"json",
				data : {
					"id" : '${system.id}',
					"systemName":data.field.systemName,
					"addres":data.field.addres,
